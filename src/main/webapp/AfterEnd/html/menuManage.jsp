		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">菜单管理</h4></li>
				</ul>
        ...
        <script type="text/javascript">
            layui.use(['table','form','layer'],function(){
                ...
                var roleTable = table.render({
                    elem:'#roleTable'
                    ,url:'${request.getContextPath()}/menu/selectAll'
                    ,cols:[[
                        {field:'muId', width:80, title: '编号',sort: true}
                        ,{field:'muName', width:110, title: '菜单'}
                        ,{field:'muLevel', width:110, title: '等级'}
                ...
                table.on('tool(demo)',function(obj){
                    ...
                    if(event=='del'){//删除
                        layer.confirm('真的要删除吗',function(index){
                            var s = {"muId":data.muId};
                            $.getJSON("${request.getContextPath()}/menu/delete",s,function(data){
