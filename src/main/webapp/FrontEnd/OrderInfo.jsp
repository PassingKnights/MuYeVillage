<%--<%@page import="pojo.RoomType"%>
<%@page import="service.RoomService"%>
<%@page import="utile.DoDate"%>
...
<head lang="en">
    ...
    <style>
       ...
       .uls li{
        ...
        #q{display: block;text-decoration: none;  width: 170px;  height: 45px;  background-color: #b01e21;  border-radius: 10px;  text-align: center;  line-height: 45px;  font-size: 20px;  font-weight: 800;  color: whitesmoke;  cursor: pointer;  margin-left:200px;margin-top:-45px}
        #q:hover{background-color: rgba(176, 30, 33, 0.9)
        }
...
<body>
	<%--<%
		...
		Order order = os.queryByOid(oid);
		request.setAttribute("order", order);
		
		int rid = order.getRid();
		RoomService rs = new RoomService();
		RoomType roomType = rs.queryByRid(rid);
		request.setAttribute("room", roomType);
		
		String start = null;
		String end = null;
		if(order!=null){
			start = DoDate.datetostr(order.getStarttime());
			end = DoDate.datetostr(order.getEndtime());
		}
...
<div class="d1">
    ...
    <ul class="con">
        ...
        <li> <div></div><span><a href="Ordering.jsp" style="text-decoration: none;">酒店预订</a></span></li>
...
<div class="taskbar">
    ...
    <div class="pp">
        <a   class="bb" href="Order.jsp" style="color:  #b01e21">我的订单</a><br/>
    </div>
    <div class="dian">
