...
<head lang="en">
    ...
    <style>
        *{ padding: 0px; margin: 0px}
        ...
        .my{position: absolute;width: 1000px;height: 600px;right: 200px;top: 130px;}
        ...
        .wei{height: 100px;margin-top: 305px;padding-top: 20px;background-color: rgba(227, 227, 227, 0.54);border-top: 1px rgba(184, 184, 184, 0.66) solid;
        }
