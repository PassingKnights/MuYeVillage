...
<head lang="en">
    ...
    <style>
        *{ padding: 0px; margin: 0px}
        ...
        .pass{ width: 100px;height: 30px;margin-right: 10px;float: right;
            margin-top: -45px;line-height: 30px;text-align: center; border-radius: 25px;border:1px #b01e21 solid }
...
<body>
    ...
    <div class="taskbar">
        ...
        <div class="pp">
            <a style="color: #b01e21">我的信息</a><br/>
            <a> 我的点评</a>
        </div>
        <div class="dian">
    ...
    <div class="my" >
        ...
        <div class="xinxi">
            <ul style="margin-top: 40px">
                <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;姓名:</div>
                <div class="tag" ></div>
                <div><input class="read ca" type="text" readonly value=${user.utruename }><span>姓名不能为空</span></div>
            </ul><br/>

            <ul>
                <div>身份证号:</div>
                <div class="tag"></div>
                <div><input class="read ca" type="text" readonly value=${user.uidentity }><span>身份证不能为空</span></div>
            </ul><br/>
             <ul>
                ...
                <div><input style="margin-left:19px" class=" read ca noe1" type="text" id="test1" name="uborn"  readonly value="${user.uborn }" placeholder="yyyy-MM-dd"><span>身份证不能为空</span>
                </div>
            </ul><br/>
            <ul>
                <div>手机号码:</div>
                <div class="tag"></div>
                <div><input class="read ca" type="text" readonly value=${user.uphone }><span>手机号不能为空</span></div>
            </ul><br/>
            <ul>
                <div>电子邮箱:</div>
                <div class="tag"></div>
                <div><input class="read ca" type="text" readonly value=${user.uemail }><span>电子邮件不能为空</span></div>
            </ul><br/>
            <ul>
                <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;性别:</div>
                <div class="tag"></div>
                <div class="ddd">
                	...
                	<input class="read read1 nan" name="sex" type="radio" checked="checked" readonly value="男"/><b class="reaa">男</b>
                    <input class="read1 nv" name="sex" type="radio" readonly value="女" style="margin-left:20px " /><b class=" reaa1 read1">女</b></c:if>
                    
                    <c:if test="${user.ugender eq '女' }">
                    <input class="read read1 nan" name="sex" type="radio"  readonly value="男"/><b class="reaa read1">男</b>
                    <input class="read1 nv" name="sex" type="radio" checked="checked" readonly value="女" style="margin-left:20px " /><b class=" reaa1 ">女</b>
                    </c:if>
                </div>
            </ul><br/>
        ...
        if(text=="编辑"){
            ...
            for(var i=0;i<5;i++){
                ...
                if(text==""){
                	...
                	$(".ca:eq("+i+")").siblings("span").css("opacity","0");
